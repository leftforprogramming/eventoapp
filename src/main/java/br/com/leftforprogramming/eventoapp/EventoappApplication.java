...
public class EventoappApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		ConvidadoModel convidadoMarcos = new ConvidadoModel("123", "Marcos");
		ConvidadoModel convidadoGabriel = new ConvidadoModel("456", "Gabriel");
		ConvidadoModel convidadoPaulo = new ConvidadoModel("789", "Paulo");

		this.convidadoRepository.saveAll(Arrays.asList(convidadoGabriel, convidadoMarcos, convidadoPaulo));
